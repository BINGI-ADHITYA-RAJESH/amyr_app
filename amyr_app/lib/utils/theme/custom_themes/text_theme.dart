...
/// customizable Light Text Theme
  ...
  headlineMedium: TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.w600,color: Colors.black),
  headlineSmall: TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.normal,color: Colors.black),
  ...
  bodyLarge: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal,color: Colors.black),
  bodyMedium: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal,color: Colors.black),
  bodySmall: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal,color: Colors.black),
...
/// customizable Dark Text Theme
  ...
  // headlineMedium: TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.w600,color: Colors.white),
  // headlineSmall: TextStyle().copyWith(fontSize: 32.0,fontWeight: FontWeight.normal,color: Colors.white),
  ...
  // bodyLarge: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal,color: Colors.white),
  // bodyMedium: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal,color: Colors.white),
  // bodySmall: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.normal,color: Colors.white),
